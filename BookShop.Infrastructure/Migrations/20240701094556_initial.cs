    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryProduct", x => x.CpId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Description", "Price", "SKU", "SubTitle", "Title" },
                values: new object[] { 1, "Best penaut butter", 59000, "penut1001", "30Nuss organic Penaut Butter", "Penaut Butter" });
